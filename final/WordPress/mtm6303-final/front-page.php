...
<div class="w3-content" style="max-width:2000px;margin-top:46px">
    ...
    <div class="w3-container w3-content w3-center w3-padding-64" style="max-width:800px" id="band">
        ...
        <div class="w3-row w3-padding-32">
            <div class="w3-third">
                <p>Name</p>
                <img src="<?php echo get_stylesheet_directory_uri() ?>/img/bandmember.jpg"
            ...
            <div class="w3-third">
                <p>Name</p>
                <img src="<?php echo get_stylesheet_directory_uri() ?>/img/bandmember.jpg" class="w3-round"
        ...
        <div class="w3-container w3-content w3-padding-64" style="max-width:800px">
            ...
            <div class="w3-row-padding w3-padding-32" style="margin:0 -16px">
                <div class="w3-third w3-margin-bottom">
                    <img src="<?php echo get_stylesheet_directory_uri() ?>/img/newyork.jpg" alt="New York"
                ...
                <div class="w3-third w3-margin-bottom">
                    <img src="<?php echo get_stylesheet_directory_uri() ?>/img/paris.jpg" alt="Paris" style="width:100%"
                ...
                <div class="w3-third w3-margin-bottom">
                    <img src="<?php echo get_stylesheet_directory_uri() ?>/img/sanfran.jpg" alt="San Francisco"
                        style="width:100%" class="w3-hover-opacity">
                    <div class="w3-container w3-white">
...
<img src="<?php echo get_stylesheet_directory_uri() ?>/img/map.jpg" class="w3-image w3-greyscale-min"
    style="width:100%">
